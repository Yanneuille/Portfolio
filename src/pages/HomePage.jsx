        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-4 pt-24 md:pt-32 text-center overflow-hidden">
          ...
          >
            ...
            >
              ...
              <Button variant="outline" size="lg" className="text-slate-300 border-slate-500 hover:bg-slate-700 hover:text-white shadow-lg transform hover:scale-105 transition-transform duration-300">
