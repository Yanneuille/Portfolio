    ...
    const AboutPage = () => {
      ...
      const timelineEvents = [
        ...
        { year: "2021", title: "Formation Intensive", description: "Bootcamp de développement full-stack, spécialisation React et Node.js." },
        { year: "2022", title: "Premiers Projets Freelance", description: "Réalisation de sites web et applications pour divers clients." },
        { year: "2023-Présent", title: "Développeur Web Confirmé", description: "Contribution à des projets d'envergure, montée en compétences continues." },
      ];
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              ...
              >
                ...
                <img  
                  className="relative rounded-lg shadow-2xl w-full h-auto max-h-[500px] object-cover" 
                  alt="Photo de profil souriant de Votre Nom"
                 src="https://images.unsplash.com/photo-1503422949567-fe46589b197a" />
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 50 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                <p className="text-lg text-slate-300 leading-relaxed">
                  En dehors du code, j'apprécie la randonnée, la photographie et explorer les dernières tendances technologiques.
                </p>
              </motion.div>
            </div>
          </motion.div>
